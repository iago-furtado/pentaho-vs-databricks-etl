...
The third notebook creates `monthly_sales_by_state_category.csv` and `monthly_sales_executive_report.pdf` under `reports/100k`, then displays a delivery summary with its elapsed time. This delivery step is not part of the ETL performance benchmark.
