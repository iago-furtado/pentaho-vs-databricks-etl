...
5. To create the delivery file, open and run `notebooks/03_gold_to_delivery_csv.py` after the Gold output is validated.
...
The third notebook creates `monthly_sales_by_state_category.csv` under `reports/100k`. This delivery step is not part of the ETL performance benchmark.
